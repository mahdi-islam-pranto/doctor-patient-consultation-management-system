...
<label for="doctorName" style="display: block; margin-top: 10px;">Doctor's Name:</label>
    ...
    <input type="file" id="doctorImage" name="file" required style="width: 100%; padding: 8px; margin-top: 5px; margin-bottom: 10px; box-sizing: border-box; background-color: #fff; color: #000;">
